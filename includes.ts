...
type Equal<T, U> = (<G>() => (G extends T ? 1 : 2)) extends (<G>() => (G extends T ? 1 : 2)) ? true : false;

type Includes<T extends readonly any[], U> = T extends [infer L, ...infer R] ? Equal<L, U> extends true ? true : Includes<R, U> : false;
