...
type GreaterThan<T extends number, U extends number> = NumberToTuple<U> extends [...NumberToTuple<T>, ...infer _] ? false : true
...
type cases = [
  ...
  Expect<Equal<GreaterThan<1234567891011, 1234567891010>, true>>, // TODO
]
