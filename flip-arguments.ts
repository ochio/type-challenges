...
type Reverse<T> = T extends [infer R, ...infer L] ? [...Reverse<L>, R] : []

type FlipArguments<T extends (...args: any) => any> = Parameters<T> extends [...args: infer U] ? (...args: Reverse<U>) => ReturnType<T> : T 
