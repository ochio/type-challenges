...
type Increment<N extends number, R extends unknown[] = []> = 
  R['length'] extends N ? [...R, unknown]['length'] : Increment<N, [...R, unknown]>;


type NumberRange<L extends number, H extends number, R extends number[] = []> = L extends H ? [...R, L][number] : NumberRange<Increment<L>, H, [...R, L]>
